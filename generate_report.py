...
POSITIVE_EXAMPLES = [
    ...
    },
    {
        ...
        "description": "Background music, sound effects, and ambient sounds are preserved in the dubbed output while the speech is replaced.",
        "clip": "fight_club_pixies_clip_1",
        "lang": "Spanish",
        "clip_label": "Fight Club — drums and guitar in background",
    },
    {
        "id": "full-occlusion",
...
NEGATIVE_EXAMPLES = [
    ...
    },
    {
        ...
        "description": "Strong emotion in the original (crying, screaming, urgency) is lost in translation. The dubbed voice sounds calm and flat regardless of the original's emotional intensity.",
        "clip": "leave_britney_alone_clip_1",
        "lang": "Spanish",
        "clip_label": "Leave Britney Alone — crying voice lost",
    },
    {
        "id": "stammering",
